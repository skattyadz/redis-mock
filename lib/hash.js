...
exports.hget = function (mockInstance, hash, key, callback) {
    ...
    if (mockInstance.storage[hash] && mockInstance.storage[hash].data[key]) {
        value = mockInstance.storage[hash].data[key];
    }
...
exports.hexists = function (mockInstance, hash, key, callback) {
    var b = mockInstance.storage[hash] && mockInstance.storage[hash].data[key] ? 1 : 0
...
exports.hdel = function (mockInstance, hash, key, callback) {
    ...
    if (mockInstance.storage[hash] && mockInstance.storage[hash].data[key]) {
        delete mockInstance.storage[hash].data[key];
        value++;
    }
...
exports.hset = function (mockInstance, hash, key, value, callback) {
    ...
    if (mockInstance.storage[hash].data[key]) {
        update = true;
    }

    mockInstance.storage[hash].data[key] = value;
